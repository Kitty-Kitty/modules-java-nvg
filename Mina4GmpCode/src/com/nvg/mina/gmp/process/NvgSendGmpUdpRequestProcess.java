 ...
 * 
 * @Title: NvgSendGmpUdpRequestProcess.java 
 * @Prject: Mina4GmpCode
 * @Package: com.nvg.mina.gmp.process 
 * @Description: TODO
 * @author: kitty fangzhenmu@novigo.com.cn     
 * @date: Mar 13, 2016 10:38:35 AM 
 * @version: V1.0   
 */
package com.nvg.mina.gmp.process;
 ...
 */
public class NvgSendGmpUdpRequestProcess extends NvgSendGmpRequestProcess {
	/** 
	 * <!-- begin-UML-doc -->
	 * <!-- end-UML-doc -->
	 * @Title :NvgSendGmpUdpRequestProcess
	 * @Description :TODO  
	 * @generated "UML to Java (com.ibm.xtools.transform.uml2.java5.internal.UML2JavaTransform)"
	 */
	public NvgSendGmpUdpRequestProcess() {
		// begin-user-code
		super.getConnector().createDatagramConnector();
		// end-user-code
	}
