...
(
   ...
   ct_status            int comment '????',
   ct_ip                national varchar(32) comment '??IP',
   ct_network           national varchar(16) comment '??',
   ct_mac               national varchar(64) comment 'MAC??',
   ct_udp_port          int default 0 comment 'udp??',
   ct_tcp_port          int default 0 comment 'tcp??',
   ct_regist_time       datetime comment '????',
...
(
   ...
   gw_status            int comment '????',
   gw_ip                national varchar(32) comment '??IP',
   gw_network           national varchar(16) comment '??',
   gw_mac               national varchar(64) comment 'MAC??',
   gw_tcp_port          int default 0 comment 'tcp??',
   gw_udp_port          int default 0 comment 'udp??',
   gw_regist_time       datetime comment '????',
   primary key (gw_id)
);
...
(
   ...
   svr_id               varchar(128),
   sys_id               varchar(128),
   rrs_type             int comment '????',
   rrs_parent           national varchar(128) comment '????????',
   rrs_name             national varchar(128) comment '????',
   rrs_show_name        national varchar(128) comment '??????',
   rrs_ip               national varchar(32) comment '????IP',
   rrs_addr             national varchar(1024) comment '??????',
   rrs_status           int comment '????',
   rrs_fps              int comment '??????',
   rrs_bps              int comment '?????',
   primary key (rrs_id)
);

alter table css_center.t_root_resource comment '??????';
...
(
   ...
   svr_status           int comment '????',
   svr_ip               national varchar(32) comment '??IP',
   svr_network          national varchar(16) comment '??',
   svr_mac              national varchar(64) comment 'MAC??',
   svr_udp_port         int default 0 comment 'udp??',
   svr_tcp_port         int default 0 comment 'tcp??',
   svr_regist_time      datetime comment '????',
...
(
   ...
   sys_status           int comment '????',
   sys_ip               national varchar(32) comment '??IP',
   sys_network          national varchar(16) comment '??',
   sys_mac              national varchar(64) comment 'MAC??',
   sys_udp_port         int default 0 comment 'udp??',
   sys_tcp_port         int default 0 comment 'tcp??',
   sys_regist_time      datetime comment '????',
