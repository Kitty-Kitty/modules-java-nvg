...
import com.nvg.css.db.domain.TVersion;

import static org.hibernate.criterion.Example.create;

/**
 * Home object for domain model class TVersion.
 * @see com.nvg.css.db.domain.TVersion
 * @author Hibernate Tools
 */
public class TVersionHome {

	private static final Logger log = LoggerFactory.getLogger(TVersionHome.class);
	...
	public TVersion merge(TVersion detachedInstance) {
		...
		try {
			TVersion result = (TVersion) sessionFactory.getCurrentSession()
	...
	public TVersion findById(java.lang.Integer id) {
		log.debug("getting TVersion instance with id: " + id);
		try {
			TVersion instance = (TVersion) sessionFactory.getCurrentSession()
					.get("com.nvg.css.db.domain.TVersion", id);
			if (instance == null) {
	...
	public List<TVersion> findByExample(TVersion instance) {
		...
		try {
			List<TVersion> results = (List<TVersion>) sessionFactory
					.getCurrentSession()
					.createCriteria("com.nvg.css.db.domain.TVersion")
