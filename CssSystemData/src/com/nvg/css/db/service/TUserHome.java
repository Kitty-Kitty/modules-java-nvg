...
import com.nvg.css.db.domain.TUser;

import static org.hibernate.criterion.Example.create;

/**
 * Home object for domain model class TUser.
 * @see com.nvg.css.db.domain.TUser
 * @author Hibernate Tools
 */
public class TUserHome {

	private static final Logger log = LoggerFactory.getLogger(TUserHome.class);
	...
	public TUser merge(TUser detachedInstance) {
		...
		try {
			TUser result = (TUser) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public TUser findById(java.lang.String id) {
		...
		try {
			TUser instance = (TUser) sessionFactory.getCurrentSession().get(
					"com.nvg.css.db.domain.TUser", id);
			if (instance == null) {
	...
	public List<TUser> findByExample(TUser instance) {
		...
		try {
			List<TUser> results = (List<TUser>) sessionFactory
					.getCurrentSession()
					.createCriteria("com.nvg.css.db.domain.TUser")
