 ...
 * @Description: gmf unsigned int type
 * @author: kitty   
 * @date: 2016年1月16日 下午4:08:13 
 * @version: V0.1.0   
 */
package com.gmf.core.gmdt;
...
/**
 * @ClassName: GmfUInt
 * @Description: class of GmfUInt
 * @author: kitty
 * @date: 2016年1月16日 下午4:08:13
 */
public class GmfUInt extends GmfElement {
	private long value = 0;

	public GmfUInt() {
		this.gmdt.setName("UIN");
		this.gmdt.setMinLength(GmfGmdtLength.GMF_GMDT_LENGTH_UIN);
	}
	/**
	 * @return the value
	 */
	...
	public int encode(Gmf gmf, byte[] dest, int pos, int length) {
		...
		if (retInt < 0) {
			this.println(GmfErrorDefined.GMF_ERROR_CRITICAL, " get unsigned int data failed.");
			return retInt;
		} else {
