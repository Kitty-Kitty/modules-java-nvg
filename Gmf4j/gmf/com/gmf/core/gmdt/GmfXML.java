 ...
 * @Description: gmf xml type
 * @author: kitty   
 * @date: 2016年1月16日 下午4:24:22 
 * @version: V0.1.0   
 */
package com.gmf.core.gmdt;
...
/**
 * @ClassName: GmfXML
 * @Description: class of GmfXML
 * @author: kitty
 * @date: 2016年1月16日 下午4:24:22
 */
public class GmfXML extends GmfElement {
	private String value = "";

	public GmfXML() {
		this.gmdt.setName("X");
		this.gmdt.setMinLength(GmfGmdtLength.GMF_GMDT_LENGTH_X);
	}
	/**
	 * @return the value
	 */
	...
	public int encode(Gmf gmf, byte[] dest, int pos, int length) {
		...
		if (retInt < 0) {
			this.println(GmfErrorDefined.GMF_ERROR_CRITICAL, " get xml string length failed.");
			return retInt;
		} else {
			tmpPos += retInt;
