 ...
 * 
 * @Title: GmfUDouble.java 
 * @Prject: GmfPraser
 * @Package: com.gmf.core.gmdt 
 * @Description: gmf unsigned double type
 * @author: kitty   
 * @date: 2016年1月16日 下午4:20:33 
 * @version: V0.1.0   
 */
package com.gmf.core.gmdt;
...
/**
 * @ClassName: GmfUDouble
 * @Description: class of GmfUDouble
 * @author: kitty
 * @date: 2016年1月16日 下午4:20:33
 */
public class GmfUDouble extends GmfElement {
	private double value = 0;

	public GmfUDouble() {
		this.gmdt.setName("UD");
		this.gmdt.setMinLength(GmfGmdtLength.GMF_GMDT_LENGTH_UD);
	}
	/**
	 * @return the value
	 */
	...
	public int encode(Gmf gmf, byte[] dest, int pos, int length) {
		...
		if (retInt < 0) {
			this.println(GmfErrorDefined.GMF_ERROR_CRITICAL, " get unsigned double data failed.");
			return retInt;
		} else {
			tmpPos += retInt;
		}
