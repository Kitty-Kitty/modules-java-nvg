 ...
 * @Description: gmf type type
 * @author: kitty   
 * @date: 2016年1月16日 下午4:22:03 
 * @version: V0.1.0   
 */
package com.gmf.core.gmdt;
...
/**
 * @ClassName: GmfType
 * @Description: class of GmfType
 * @author: kitty
 * @date: 2016年1月16日 下午4:22:03
 */
public class GmfType extends GmfElement {
	private int value = 0;

	public GmfType() {
		this.gmdt.setName("T");
		this.gmdt.setMinLength(GmfGmdtLength.GMF_GMDT_LENGTH_T);
	}
	/**
	 * @return the value
	 */
