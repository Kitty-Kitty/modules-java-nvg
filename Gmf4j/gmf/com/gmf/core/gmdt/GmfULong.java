 ...
 * @Description: gmf unsigned long type
 * @author: kitty   
 * @date: 2016年1月16日 下午4:12:37 
 * @version: V0.1.0   
 */
package com.gmf.core.gmdt;
...
/**
 * @ClassName: GmfULong
 * @Description: class of GmfULong
 * @author: kitty
 * @date: 2016年1月16日 下午4:12:37
 */
public class GmfULong extends GmfElement {
	private long value = 0;

	public GmfULong() {
		this.gmdt.setName("UL");
		this.gmdt.setMinLength(GmfGmdtLength.GMF_GMDT_LENGTH_UL);
	}
	/**
	 * @return the value
	 */
	...
	public int encode(Gmf gmf, byte[] dest, int pos, int length) {
		...
		if (retInt < 0) {
			this.println(GmfErrorDefined.GMF_ERROR_CRITICAL, " get unsigned long data failed.");
			return retInt;
		} else {
			tmpPos += retInt;
		}
