 ...
 * 
 * @Title: GmfUFloat.java 
 * @Prject: GmfPraser
 * @Package: com.gmf.core.gmdt 
 * @Description: gmf unsigned float type
 * @author: kitty   
 * @date: 2016年1月16日 下午4:16:28 
 * @version: V0.1.0   
 */
package com.gmf.core.gmdt;
...
/**
 * @ClassName: GmfUFloat
 * @Description: class of GmfUFloat
 * @author: kitty
 * @date: 2016年1月16日 下午4:16:28
 */
public class GmfUFloat extends GmfElement {
	private float value = 0;

	public GmfUFloat() {
		this.gmdt.setName("UF");
		this.gmdt.setMinLength(GmfGmdtLength.GMF_GMDT_LENGTH_UF);
	}
	/**
	 * @return the value
	 */
	...
	public int encode(Gmf gmf, byte[] dest, int pos, int length) {
		...
		if (retInt < 0) {
			this.println(GmfErrorDefined.GMF_ERROR_CRITICAL, " get unsigned float data failed.");
			return retInt;
		} else {
			tmpPos += retInt;
		}
