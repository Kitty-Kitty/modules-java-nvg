 ...
 * 
 * @Title: GmfDoubleArrayDeserializer.java 
 * @Prject: GmfPraser
 * @Package: com.gmf.core.deserializer.array 
 * @Description: double array deserializer 
 * @author: kitty   
 * @date: 2016年1月27日 下午5:03:52 
 * @version: V0.1.0   
 */
package com.gmf.core.deserializer.array;
...
/**
 * @ClassName: GmfDoubleArrayDeserializer
 * @Description: double array deserializer class
 * @author: kitty
 * @date: 2016年1月27日 下午5:03:52
 */
public class GmfDoubleArrayDeserializer extends GmfArrayDeserializer {
	@Override
		...
		if (value instanceof List) {
			...
			if (listSize > 0) {
				...
				for (int i = 0; i < listSize; i++) {
					...
					if (itemObjectValue instanceof Double) {
