 ...
 * 
 * @Title: GmfShortArrayDeserializer.java 
 * @Prject: GmfPraser
 * @Package: com.gmf.core.deserializer.array 
 * @Description: short array deserializer 
 * @author: kitty   
 * @date: 2016年1月27日 下午5:07:41 
 * @version: V0.1.0   
 */
package com.gmf.core.deserializer.array;
...
/**
 * @ClassName: GmfShortArrayDeserializer
 * @Description: Short array deserializer class
 * @author: kitty
 * @date: 2016年1月27日 下午5:07:41
 */
public class GmfShortArrayDeserializer extends GmfArrayDeserializer {
	@Override
