 ...
 * 
 * @Title: GmfFloatArrayDeserializer.java 
 * @Prject: GmfPraser
 * @Package: com.gmf.core.deserializer.array 
 * @Description: float array deserializer 
 * @author: kitty   
 * @date: 2016年1月27日 下午5:04:42 
 * @version: V0.1.0   
 */
package com.gmf.core.deserializer.array;
...
/**
 * @ClassName: GmfFloatArrayDeserializer
 * @Description: float array deserializer class
 * @author: kitty
 * @date: 2016年1月27日 下午5:04:42
 */
public class GmfFloatArrayDeserializer extends GmfArrayDeserializer {
	@Override
		...
		if (value instanceof List) {
			...
			if (listSize > 0) {
				...
				for (int i = 0; i < listSize; i++) {
					...
					if (itemObjectValue instanceof Float) {
