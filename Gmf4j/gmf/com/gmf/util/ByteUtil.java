...
public class ByteUtil {
	...
	public static int getByteInt(byte[] bytes) {
		return (0x000000ff & bytes[0]);
	}
	...
	public static byte[] subBytes(byte[] src, int index, int count) {
	...
	public static String subBytesToString(byte[] src, int index, int count, String encode) {
		byte[] b = new byte[count];
